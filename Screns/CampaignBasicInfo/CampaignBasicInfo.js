  ...
  return (
    ...
    <button className={styles.back_btn}>Back</button>
        ...
        <div className={styles.campaignBasicInfoTwo}>
            <p className={styles.paragraph_campaignBasicInfo}>Campaign basic info</p> 
            ...
            <div className={styles.email_input_div}>
              ...
              <input className={styles.input} type="text" placeholder="Enter campaign name" />
              <p className={styles.email_text_public}>Public name</p>
              <input className={styles.inputPublic} type="text" placeholder="Public name" />
            </div>
            <div className={styles.email_input_div}>
...
<select name="cars" id="cars" className={styles.dropdown_campaignBasicInfo}>
  <option value="volvo" className={styles.dropdown_campaignBasicInfo}>Volvo</option>
  <option value="saab" className={styles.dropdown_campaignBasicInfo}>Saab</option>
  <option value="mercedes" className={styles.dropdown_campaignBasicInfo}>Mercedes</option>
  <option value="audi" className={styles.dropdown_campaignBasicInfo}>Audi</option>
</select>
            </div>
          </div>
        </div>
